...
PKG_ARCH="any"
PKG_LICENSE="GPL"
PKG_MAINTAINER="Paul Mackerras <paulus@samba.org>"
PKG_SITE="http://samba.org/"
PKG_URL="http://samba.org/ftp/ppp/$PKG_NAME-$PKG_VERSION.tar.gz"
PKG_DEPENDS_TARGET=""
PKG_PRIORITY="optional"
PKG_SECTION="network"
PKG_SHORTDESC="The pppd daemon and the chat program. This is used for connecting to other machines; often for connecting to the Internet via a dial-up or PPPoE connection to an ISP."

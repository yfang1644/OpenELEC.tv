...
PKG_URL="http://sourceforge.net/projects/fluxbox/files/$PKG_NAME/${PKG_VERSION}/$PKG_NAME-${PKG_VERSION}.tar.gz"
PKG_DEPENDS_TARGET="libXrandr libXext libXrender imlib2"
PKG_PRIORITY="optional"
PKG_SECTION="x11/other"
PKG_SHORTDESC="Windowmanager for X that was based on the Blackbox 0.61.1 code"
PKG_LONGDESC="Fluxbox is a windowmanager for X that was based on the Blackbox 0.61.1 code. It is very light on resources and easy to handle but yet full of features to make an easy, and extremely fast, desktop experience."
